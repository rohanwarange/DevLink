    ...
    public void saveComment(Comment comment) {
        if (comment.getId() == 0) {
            ...
            if (comment.getParentComment() != null && comment.getParentComment().getAuthor() != comment.getAuthor()) {
                ...
                notification.setContent(comment.getAuthor().getDisplayName() + " has replied to your comment.");
                ...
                notification.setContent(comment.getAuthor().getDisplayName() + " has commented on your post.");
                notificationService.sendNotification(notification);
            }
        }
